...
<div class="container">
        <div class="login-container">
          <div class="register">
            <h2>Lista Ejemplar</h2>
            <div class="row">
                <div class="col-lg-12">
                    <a href="ejemplar.php"><button class="btn btn-primary mb-2" type="button" >Nuevo</button></a>
                    <div class="table-responsive">
                        <table class="table table-light mt-4" id="table">
                            ...
                            $conn->CrearConexionSin();
                                ...
                                while($registroejemplar = $result->fetch_array(MYSQLI_BOTH))
                                  {
                                    echo "<tr>";
                                        echo "<td>"; echo $registroejemplar["id"]; echo "</td>";
                                        echo "<td>"; echo $registroejemplar["localizacion"]; echo "</td>";
                                        echo "<td><a href='actualizarEjemplar.php?id=".$registroejemplar['id']."&localizacion=".$registroejemplar['localizacion']."'> <button class='btn btn-success' type='button'>Modificar</button></a>
                                              </td>";    
                                         echo "<td> <a href='../Controller/EjemplarController.php?id=".$registroejemplar['id']."&localizacion=".$registroejemplar['localizacion']."'> <button class='btn btn-danger' type='submit' name='Eliminar'>Eliminar</button></a>
                                            </td>";
