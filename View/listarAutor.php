...
<div class="container">
        <div class="login-container">
          <div class="register">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a href="autor.php"><button class="btn btn-primary mb-2" type="button" >Nuevo</button></a>
                        ...
                        <table class="table table-light mt-4" id="table">
                            ...
                            <tbody>
                              ...
                              $conn->CrearConexionSin();
                                ...
                                while($registroautores = $result->fetch_array(MYSQLI_BOTH))
                                  {
                                    echo "<tr>";
                                        echo "<td>"; echo $registroautores["id"]; echo "</td>";
                                        echo "<td>"; echo $registroautores["nombre"]; echo "</td>";
                                        echo "<td><a href='actualizarAutor.php?id=".$registroautores['id']."&nombre=".$registroautores['nombre']."'> <button class='btn btn-success' type='button'>Modificar</button></a>
                                              </td>";    
                                         echo "<td> <a href='../Controller/AutorController.php?id=".$registroautores['id']."&nombre=".$registroautores['nombre']."'> <button class='btn btn-danger' type='submit' name='Eliminar'>Eliminar</button></a>
                                            </td>";
