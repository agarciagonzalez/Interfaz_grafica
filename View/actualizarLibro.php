        ...
        <div class="login-container">
          <div class="register">
            ...
            <form method="POST" action="../Controller/LibroController.php">
                ...
                <input type="text" placeholder="Titulo" name="titulo" value="<?php echo $_GET['titulo'] ?>">
                <input type="text" placeholder="ISBN" name="isbn" value="<?php echo $_GET['isbn'] ?>">
                <input type="text" placeholder="Paginas" name="paginas" value="<?php echo $_GET['paginas'] ?>">
                <input type="text" placeholder="Editorial" name="editorial" value="<?php echo $_GET['editorial'] ?>">
                <?php 
