        ...
        <div class="login-container">
          <div class="register">
            ...
            <form method="POST" action="../Controller/UsuarioController.php">
                ...
                <input type="text" placeholder="Direccion" name="direccion" value="<?php echo $_GET['direccion'] ?>">
                <input type="text" placeholder="Telefono" name="telefono" value="<?php echo $_GET['telefono'] ?>">
